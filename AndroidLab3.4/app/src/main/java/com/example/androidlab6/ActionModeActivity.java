...
public class ActionModeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        for (int i = 0; i <= 3; i++)
        {
            ...
            mp.put("name", names[i]);
            mp.put("img", R.drawable.dog);
            lst.add(mp);
        }

        SimpleAdapter sa = new SimpleAdapter(this, lst, R.layout.list_unit, new String[]{"name", "img"}, new int[]{R.id.list_unit_02_name, R.id.list_unit_02_img});
